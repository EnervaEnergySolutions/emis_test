...
import { FacilityAssessmentAnswer, FacilityAssessmentResults, AssessmentSection, QuestionRecommendation } from '../types';
...
const FacilityAssessment: React.FC<FacilityAssessmentProps> = ({ onComplete }) => {
  ...
  const calculateResults = (): FacilityAssessmentResults => {
    ...
    Object.values(answers).forEach(answer => {
      ...
      if (nextStepConfig && answer.score < nextStepConfig.threshold) {
        conditionalNextStep = nextStepConfig.text;
      }

      recommendations.push({
        questionTitle: question.title,
        selectedAnswer: selectedOption.text,
        selectedAnswerDescription: selectedOption.description,
        conditionalNextStep,
        score: answer.score
      });
    });
